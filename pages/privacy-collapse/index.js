      ...
      <Row justify={'center'}>
        <Col xs={23} sm={20} md={15} lg={14}>
          <Collapse defaultActiveKey={['1']}>
            ...
            <Panel header={<Title level={5}>SECTION 2: Consent</Title>} key="2">
              <Paragraph>
                <p>Do you store cookies?</p>
                <p>
                  By using our site, you accept the use of cookies with{' '}
                  <a href="https://aws.amazon.com" target="_blank">aws.amazon.com</a> for us to
                  provide a better and more personalized experience. By
                  registering to our site, you will automatically be enrolled in
                  our email marketing programs to be provided with the latest
                  news, discounts, promotions and content. DigiCloud Hosting
                  promises our users the ability to easily unsubscribe from our
                  email marketing subscription through every email sent or
                  getting in touch via the contact us form.
                </p>
                ...
                <p>
                  ...
                  by getting in touch via the contact us form.
                </p>
              </Paragraph>
            </Panel>
            <Panel
              header={<Title level={5}>SECTION 3: Third-Party Services</Title>}
              key="3"
            >
              <Paragraph>
                <p>
                ...
                <p>
                  ...
                  from our site. We are not responsible for the privacy
            ...
            <Panel
              header={<Title level={5}>SECTION 4: Security</Title>}
              key="4"
            >
              <Paragraph>
                <p>
            ...
            <Panel
              header={<Title level={5}>SECTION 5: Age of Consent</Title>}
              key="5"
            >
              <Paragraph>
                <p>
                  By using this site, you represent that you are at least the
                  age of majority in your state or proof of residence, or that
                  you are the age of majority in your state or proof of
            ...
            >
              <Paragraph>
                <p>
                  ...
                  personal information we have about you, register a complaint,
                  or simply want more information you’re welcome to get in touch
