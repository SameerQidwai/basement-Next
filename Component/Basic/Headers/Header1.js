...
import { FacebookOutlined, TwitterOutlined, InstagramOutlined, RedditOutlined, LinkedinOutlined} from '@ant-design/icons';
...
const Header1 = (props) =>{
    return (
      <Header style={styles.header}>
        <div>
          <Row  className="header1 px-30 py-2" justify="space-between" align="middle">
            <Col className='pt-10' xs={24} sm={10}>
              <Row gutter={[16]} className="xs-center" >
                <Col>
                  <Tooltip title="Facebook" arrowPointAtCenter>
                    <a target={"_blank"} href="https://www.facebook.com/" className='reset-a'> 
                ...
                <Col>
                  <Tooltip title="Twitter" arrowPointAtCenter>
                    <a target={"_blank"} href="https://www.twitter.com/" className='reset-a'> 
                ...
                <Col>
                  <Tooltip title="LinkedIn" arrowPointAtCenter>
                    <a target={"_blank"} href="https://www.linkedIn.com/" className='reset-a'> 
              ...
              <Row gutter={[20]} align="middle" className="xs-center" >
                <Col>
                  <Tooltip title="Goto" arrowPointAtCenter>
                    <a target={"_blank"} href="https://www.Blogspot.com/" className='reset-a'> 
