...
import { FacebookFilled , TwitterSquareFilled , InstagramFilled , RedditOutlined, LinkedinOutlined} from '@ant-design/icons';
        ...
        <div>
          <Row className="hedear-basement-1" align="middle">
            ...
            <Col xs={24} sm={8} md={6}>
              ...
              >
                <span className='fs-13 lh-1'>we are only a phone call away</span>
                <br/>
