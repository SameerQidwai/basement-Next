...
export const ThreadIcon = () => {
  return (
    <Tooltip title="Threads" arrowPointAtCenter>
      <a
        target={'_blank'}
...
export const InstgramIcon = ({addClassName}) => {
  let className = `reset-a ${addClassName}`
  return (
...
export const FacebookIcon = ({addClassName = ''}) => {
  let className = `reset-a ${addClassName}`
  return (
